...
import PPrefuge from '../assets/PPrefuge.png'
    ...
    <div className='ContainerRefugeprofil'>
      ...
      <div className='block123'>
        <div className="ContainerRefugeProfil2">
          <img src={PPrefuge} alt="" className='PPrefuge' />
        </div>
        ...
        <Link to="/MesAnimaux" style={{ position: 'absolute', bottom: '-70px', left: '50%', transform: 'translateX(-50%)', width: '80%' }}>
          <Button
            variant="contained"
            disableElevation
            style={{
